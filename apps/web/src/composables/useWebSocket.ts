...
// Default to same-origin so it works on localhost AND HTTPS tunnels (ngrok).
// Set VITE_WS_BASE_URL in production if the WebSocket lives on a different origin.
